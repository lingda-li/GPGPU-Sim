...
protected:
    ...
    bool *m_cur_hash_bit_array;
    bool *m_hash_bit_array0;
    bool *m_hash_bit_array1;
    bool m_default_prediction; // true is bypass
    unsigned m_total_victim;
    unsigned m_hash_insertion;
